# LocalSpot — Build Roadmap

## Done
- [x] Fix LocationGate DialogContent build error
- [x] Forced profile setup popup (name, gender, mobile, photo w/ progress, notification opt-in) — saves to DB, shows once
- [x] Location: permission states, manual fallback card, live tracking as user moves
...
- [ ] Home page upgrade, signup copy (remove "list & manage my place"), footer "Our cozy homes in"
